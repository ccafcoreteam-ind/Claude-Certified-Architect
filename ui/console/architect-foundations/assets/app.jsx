      ...
      <div className="main">
        ...
        <div className="scroll app-bg" ref={scrollRef}>
          ...
          <footer className="app-foot">
            <p className="foot-credit">Built by <b>Jacinth Paul</b> — to help aspirants on their Claude Certified Architect journey.</p>
            <p className="foot-disclaimer">
              ...
              material to help you prepare for the Claude Certified Architect — Foundations exam.
